...
function beannacht(duine) {
  return ("Dia duit, " + duine.ainm);
}
function dúbail(x) {
  return (x + x);
}
const duine = { __cineál: "Duine", ainm: "Charlotte", aois: 20 };
const teachtaireacht = beannacht(duine);
scríobh(teachtaireacht);
scríobh(dúbail(duine.aois));

module.exports = { Duine$nua, beannacht, dúbail, duine, teachtaireacht };
